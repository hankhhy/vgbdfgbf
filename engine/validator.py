...
class BaseValidator:
    ...
    def __init__(self, dataloader=None, save_dir=None, pbar=None, args=None):
        ...
        if self.args.conf is None:
            ...
            self.args.conf = 0.05  # 设置与NanoDet相同阈值
            self.args.iou = 0.6  # default iou=0.7
            self.args.max_det = 100
    ...
    def __call__(self, trainer=None, model=None):
        ...
        if self.training:
            ...
            # model.warmup(imgsz=(1 if pt else self.args.batch, 1, imgsz, imgsz))  # 单通道
        ...
        for batch_i, batch in enumerate(bar):
            ...
            self.update_metrics(preds, batch_i, batch)
        ...
        if self.training:
            ...
            if self.args.save_json and self.jdict:
                with open(str(self.save_dir / 'predictions.json'), 'w', encoding="utf-8") as f:
                    ...
                    json.dump(self.jdict, f, indent=4, ensure_ascii=False)  # flatten and save
